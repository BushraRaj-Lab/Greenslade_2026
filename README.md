...
This script outlines the generation of a consensus peakset used to construct ChromatinAssays and Signac objects. It details genome annotation, initial Quality Control (QC), and data filtering steps. The workflow utilizes CellRanger aggr outputs; while peak and metadata files are included here, the larger fragment files and H5 files should be retrieved from GEO (Accession: GSE324435).
